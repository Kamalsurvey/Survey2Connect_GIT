...
public class addMultiChoice extends configTest{
	...
	testLogger=Logger.getLogger(addMultiChoice.class);

		}


	@Test
	public void clickMultiChoice() throws InterruptedException
	{
		testLogger.info("Clicking on MultChoice con");
		try{waitforElementBYXpath(By.xpath(AddQuestionObjects.MultiChoice));
		dropdownIcon=driver.findElement(By.xpath(AddQuestionObjects.MultiChoice));
		dropdownIcon.click();
		testLogger.info("Mult Choice has been clicked successfully");
		} catch(Exception e){
			testLogger.error("Mult Choice could not be clicked");
	...
	@Test(dependsOnMethods="clickMultiChoice")
	public void addMultiChoice()
	{
		testLogger.info("Creating Mult Choice Question");
		...
		driver.findElement(By.xpath(AddQuestionObjects.dropdown_QuestionTextArea)).sendKeys("Mult Choice");
		...
		testLogger.info("Mult Choice  Question has been created successfully");
		}catch(Exception e){
			testLogger.info("Problem occured creating Mult Choice .");
			testLogger.error(e.getMessage());
			e.printStackTrace();
			Assert.fail();
		}
	...
	{ 
		...
		{status="PASS";
		generateReport.addPassStatus(testcounter,"ADD Mult Choice", status);}
		break;
		case ITestResult.FAILURE:
		{status="FAIL";
		generateReport.addFailStatus(testcounter,"ADD Mult Choice", status);}
		break;

...
public class addSlider_DT1 extends configTest{
	...
	public addSlider_DT1()
	{driver=configTest.getDriver();
	testLogger=Logger.getLogger(addSlider_DT1.class);
	...
	public void addSlider()
	{
		...
		driver.findElement(By.xpath(AddQuestionObjects.dropdown_QuestionTextArea)).sendKeys("Slider Discrete Type 1");
		...
		testLogger.info("Slider Discrete Type 1 Question has been created successfully");
		}catch(Exception e){
			testLogger.info("Problem occured creating Dropdown Slider Discrete Type 1 Question .");
			testLogger.error(e.getMessage());
			e.printStackTrace();
			Assert.fail();
		}
	...
	{ 
		...
		{status="PASS";
		generateReport.addPassStatus(testcounter,"ADD Slider Discrete Type 1", status);}
		break;
		case ITestResult.FAILURE:
		{status="FAIL";
		generateReport.addFailStatus(testcounter,"ADD Slider Discrete Type 1", status);}
		break;

...
public class addSlider_DT2 extends configTest{
	...
	public addSlider_DT2()
	{driver=configTest.getDriver();
	testLogger=Logger.getLogger(addSlider_DT2.class);
	...
	public void addSlider()
	{
		...
		driver.findElement(By.xpath(AddQuestionObjects.dropdown_QuestionTextArea)).sendKeys("Slider Question Discrete Type 2");
		...
		testLogger.info("Slider Discrete Type 2 Question has been created successfully");
		}catch(Exception e){
			testLogger.info("Problem occured creating Dropdown Slider Discrete Type 2 Question .");
			testLogger.error(e.getMessage());
			e.printStackTrace();
			Assert.fail();
		}
	...
	{ 
		...
		{status="PASS";
		generateReport.addPassStatus(testcounter,"ADD Slider Discrete Type 2", status);}
		break;
		case ITestResult.FAILURE:
		{status="FAIL";
		generateReport.addFailStatus(testcounter,"ADD Slider Discrete Type 2", status);}
		break;

...
public class addSlider_CT3 extends configTest{
	...
	public addSlider_CT3()
	{driver=configTest.getDriver();
	testLogger=Logger.getLogger(addSlider_CT3.class);
	...
	public void addSlider()
	{
		...
		driver.findElement(By.xpath(AddQuestionObjects.dropdown_QuestionTextArea)).sendKeys("Slider Question Continuous Type 3");
		...
		testLogger.info("Slider Continuous Type 3 Question has been created successfully");
		}catch(Exception e){
			testLogger.info("Problem occured creating Dropdown Slider Continuous Type 3 Question .");
			testLogger.error(e.getMessage());
			e.printStackTrace();
			Assert.fail();
		}
	...
	{ 
		...
		{status="PASS";
		generateReport.addPassStatus(testcounter,"ADD Slider Continuos Type3 Slider", status);}
		break;
		case ITestResult.FAILURE:
		{status="FAIL";
		generateReport.addFailStatus(testcounter,"ADD Slider Continuos Type3", status);}
		break;
